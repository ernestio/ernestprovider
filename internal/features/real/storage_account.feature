...
Feature: Storage account
  ...
  Scenario: Creting a storage_account
    ...
    Then I should get a "azure_storage_account.create.azure.done" response with "name" as "satest1082376408127"
    ...
    And I should get a "azure_storage_account.create.azure.done" response with "account_type" as "Standard_LRS"
    ...
    Then I should get a "azure_storage_account.update.azure.done" response with "name" as "satest1082376408127"
    And I should get a "azure_storage_account.update.azure.done" response with "tags.t3" as "three"
    When I request "azure_storage_account.get.azure" with "sa_update.json"
    Then I should get a "azure_storage_account.get.azure.done" response with "name" as "satest1082376408127"
    ...
    And I should get a "azure_storage_account.get.azure.done" response with "account_type" as "Standard_LRS"
    And I should get a "azure_storage_account.get.azure.done" response with "tags.t1" as "one"
    And I should get a "azure_storage_account.get.azure.done" response with "tags.t2" as "two"
    And I should get a "azure_storage_account.get.azure.done" response with "tags.t3" as "three"
    ...
    Then I should get a "azure_storage_account.get.azure.error" response with "error" as "Resource not found"
