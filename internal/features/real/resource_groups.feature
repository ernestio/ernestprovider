...
Feature: Resource group
  ...
  Scenario: Creting a resource group
    ...
    And I should get a "azure_resource_group.update.azure.done" response with "tags.t1" as "one_x"
    And I should get a "azure_resource_group.update.azure.done" response with "tags.t2" as "two_x"
    ...
    And I should get a "azure_resource_group.get.azure.done" response with "tags.t1" as "one_x"
    And I should get a "azure_resource_group.get.azure.done" response with "tags.t2" as "two_x"
    ...
    Then I should get a "azure_resource_group.get.azure.error" response with "error" as "Error reading resource group  - removing from state"
