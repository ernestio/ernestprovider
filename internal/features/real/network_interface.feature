...
Feature: Network Interface
  ...
  Scenario: Creting a network_interface
    ...
    And I should get a "azure_network_interface.create.azure.done" response with "ip_configuration.0.name" as "ip_conf_test"
    And I should get a "azure_network_interface.create.azure.done" response with "ip_configuration.0.subnet_id" containing "sub_test_II"
    And I should get a "azure_network_interface.create.azure.done" response with "ip_configuration.0.private_ip_address_allocation" as "dynamic"
    ...
    When I request "azure_network_interface.get.azure" with "ni_create.json"
    ...
    And I should get a "azure_network_interface.get.azure.done" response with "ip_configuration.0.name" as "ip_conf_test"
    And I should get a "azure_network_interface.get.azure.done" response with "ip_configuration.0.subnet_id" containing "sub_test_II"
    And I should get a "azure_network_interface.get.azure.done" response with "ip_configuration.0.private_ip_address_allocation" as "dynamic"
    And I should get a "azure_network_interface.get.azure.done" response with "ip_configuration.0.name" as "ip_conf_test"
    And I should get a "azure_network_interface.get.azure.done" response with "tags.t1" as "one"
    And I should get a "azure_network_interface.get.azure.done" response with "tags.t2" as "two"
    When I request "azure_network_interface.delete.azure" with "ni_create.json"
    And I request "azure_network_interface.get.azure" with "ni_create.json"
    Then I should get a "azure_network_interface.get.azure.error" response with "error" as "Resource not found"
