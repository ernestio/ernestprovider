...
type Event struct {
	...
	VirtualNetworkName     string            `json:"virtual_network_name" validate:"required" diff:"-"`
	AddressPrefix          string            `json:"address_prefix"  validate:"required" diff:"-"`
	...
	IPConfigurations       []string          `json:"ip_configurations" diff:"-"`
