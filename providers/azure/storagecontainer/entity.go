...
type Event struct {
	...
	StorageAccountName  string            `json:"storage_account_name" validate:"required" diff:"-"`
	ContainerAccessType string            `json:"container_access_type" diff:"-"`
	Properties          map[string]string `json:"properties" diff:"-"`
